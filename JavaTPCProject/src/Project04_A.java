...
public class Project04_A {
	...
	String[][] rows = new String[][] {
		...
		{"리눅스 프로그램","창병모", "생능출판", "https://bookthumb-phinf.pstatic.net/cover/100/365/10036542.jpg"},	
	};
	...
	try {
		...
		doc.open();
		//한글 폰트
		BaseFont bf=BaseFont.createFont("H2MJRE.TTF",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
